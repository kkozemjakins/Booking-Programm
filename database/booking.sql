...
-- Dumping data for table booking.offers: ~6 rows (approximately)
...
CREATE TABLE IF NOT EXISTS `offers.infodetailed` (
  `offersInfoDetailedID` int(11) NOT NULL AUTO_INCREMENT,
  `OffersID` int(11) DEFAULT NULL,
...
/*!40000 ALTER TABLE `offers.infodetailed` DISABLE KEYS */;
/*!40000 ALTER TABLE `offers.infodetailed` ENABLE KEYS */;
